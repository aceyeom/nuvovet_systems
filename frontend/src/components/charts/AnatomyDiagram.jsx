...
const ANATOMY_IMAGE_CONFIG = {
  dog: {
    ...
    sections: {
      ...
      blood:  { type: 'line', d: 'M 101 92 C 115 95, 126 104, 134 118 C 151 143, 184 152, 224 154 C 265 156, 307 154, 347 157 C 369 160, 388 167, 403 177 M 248 154 C 245 181, 243 218, 241 305 M 349 160 C 357 185, 367 226, 377 306', strokeWidth: 10, hitWidth: 28 },
    },
  ...
  cat: {
    ...
    sections: {
      ...
      blood:  { type: 'line', d: 'M 74 49 C 85 53, 94 60, 101 70 C 113 84, 138 90, 168 92 C 198 94, 226 95, 253 99 C 276 102, 295 108, 312 120 M 124 92 C 117 112, 113 138, 111 171 M 166 93 C 163 114, 162 141, 163 173 M 233 98 C 239 118, 246 145, 253 175 M 269 102 C 279 120, 290 144, 300 171', strokeWidth: 7, hitWidth: 20 },
    },
    labelAnchors: {
